...
const links = [
    { href: 'https://github.com/Al-aminAzad', icon: <FaGithub /> },
    { href: 'https://www.linkedin.com/in/al-aminazad/', icon: <FaLinkedin /> },
    { href: 'https://www.facebook.com/AlaminAzad0/', icon: <FaFacebook /> },
];
        ...
        <footer className="w-screen bg-violet-300 py-4 text-black">
            <div className="container mx-auto flex flex-col items-center justify-between gap-4 px-4 md:flex-row" >
                <p className="text-center text-sm md:text-left" >
                    &copy; Al-amin Azad 2025. All rights reserved.
                </p>
